...
From the original data set a series of steps were followed in order to obtain a tidy data set for further postprocessing. To carry out this process the main.R script was used. The steps in the script are as follows:
